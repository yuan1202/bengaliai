...
logger = CSVLogger(learn, 'Seresnext50_Size168_BestAug_Nosplitmodel_Nowd_CmMu_1of7')
...
learn.fit_one_cycle(
    ...
    pct_start=0.0,
    div_factor=100,
    callbacks=[logger, SaveModelCallback(learn, monitor='metric_tot', mode='max', name='Seresnext50_Size168_BestAug_Nosplitmodel_Nowd_CmMu_1of7'), MuCmCallback(learn)] # 
)
