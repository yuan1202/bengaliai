...
from mixup_fastai_utils import MuCmCallback
...
imgs = bp.unpack_ndarray_from_file('../features/train_images_size168_pad10_max_noclean.bloscpack')
...
classifier.load_state_dict(torch.load('mdl_seresxtorig_168168_lessaugs_mucm_fixed_half_sgd_onecycle_fld0of5_backup0.pth'))
...
# learn.clip_grad = 1.0
name = 'mdl_seresxtorig_168168_lessaugs_mucm_fixed_half_sgd_onecycle_fld0of5'
