...
from models_mg import Simple50AnM
...
augs = iaa.PiecewiseAffine(scale=.04)

# erode and dialte removed in dataset.
...
classifier = Simple50AnM()


# In[8]:

logging_name = 'MG_model_script_ModelMg_SeperateHead_Affine_3ChSize128Pad3_OneCycle_Mu'
...
learn.fit_one_cycle(
    ...
    pct_start=0.0,
    div_factor=100,
    callbacks=[logger, SaveModelCallback(learn, monitor='metric_tot', mode='max', name=logging_name), MixUpCallback(learn, alpha=.9)]
)
