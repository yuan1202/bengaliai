...
from mixup_fastai_utils import MuCmCallback, MuGmCallback_InnerPeace
...
classifier = mdl_sext50()

classifier.load_state_dict(torch.load('mdl_seresxt50mg_168168_lessaugs_mugm_fixed_adam_onecycle_fld4of5_backup.pth'))
...
# learn.clip_grad = 1.0
name = 'mdl_seresxt50mg_168168_lessaugs_mugm2mucm_fixed_adam_onecycle_fld4of5'
